...
#define STRING_CONFIG_H_AUTHOR "MerciJacquieEtMichel" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "Merci-Michel"
...
#define DISCO_MINI_FAN_SPEED 100 //minimum speed for the head fan to prevent head softening over printing
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER 1.80 // -12.35 //disco ici l'offset de base pour Z
